...
def create_plain_joints_patternbook() -> PatternBook:
    ...
    patterns = [
        (PatternMetadata("miter_joint", ["plain_joints", "miter", "corner"], "frame"),
         _make_frame_pattern(make_miter_joint_example, "Miter Joint (67°)")),

        (PatternMetadata("miter_joint_face_aligned", ["plain_joints", "miter", "corner"], "frame"),
         _make_frame_pattern(make_miter_joint_face_aligned_example, "Miter Joint (Face Aligned)")),

        (PatternMetadata("miter_joint_3d_angles", ["plain_joints", "miter", "corner"], "frame"),
         _make_frame_pattern(make_miter_joint_3d_angles_example, "Miter Joint (3D Angles)")),

        (PatternMetadata("butt_joint", ["plain_joints", "butt", "butt"], "frame"),
         _make_frame_pattern(make_butt_joint_example, "Butt Joint")),

        (PatternMetadata("butt_joint_3d_angles", ["plain_joints", "butt", "butt"], "frame"),
         _make_frame_pattern(make_butt_joint_3d_angles_example, "Butt Joint (3D Angles)")),

        (PatternMetadata("tongue_and_fork_corner_joint_90", ["plain_joints", "tongue_and_fork", "corner"], "frame"),
         _make_frame_pattern(make_tongue_and_fork_corner_joint_90_example, "Tongue and Fork Corner (90°)")),

        (PatternMetadata("tongue_and_fork_corner_joint_135", ["plain_joints", "tongue_and_fork", "corner"], "frame"),
         _make_frame_pattern(make_tongue_and_fork_corner_joint_135_example, "Tongue and Fork Corner (135°)")),

        (PatternMetadata("tongue_and_fork_butt_joint_90", ["plain_joints", "tongue_and_fork", "butt"], "frame"),
         _make_frame_pattern(make_tongue_and_fork_butt_joint_90_example, "Tongue and Fork Butt (90°)")),

        (PatternMetadata("tongue_and_fork_butt_joint_138", ["plain_joints", "tongue_and_fork", "butt"], "frame"),
         _make_frame_pattern(make_tongue_and_fork_butt_joint_angled_example, "Tongue and Fork Butt (138°)")),

        (PatternMetadata("splice_joint", ["plain_joints", "splice", "end"], "frame"),
         _make_frame_pattern(make_splice_joint_example, "Splice Joint")),

        (PatternMetadata("splice_lap_joint", ["plain_joints", "splice_lap", "end"], "frame"),
         _make_frame_pattern(make_splice_lap_joint_example, "Splice Lap Joint")),

        (PatternMetadata("house_joint", ["plain_joints", "house", "cross"], "frame"),
         _make_frame_pattern(make_house_joint_example, "House Joint")),

        (PatternMetadata("cross_lap_joint", ["plain_joints", "cross_lap", "cross"], "frame"),
         _make_frame_pattern(make_cross_lap_joint_example, "Cross Lap Joint")),

        (PatternMetadata("corner_lap_joint", ["plain_joints", "corner_lap", "corner"], "frame"),
         _make_frame_pattern(make_corner_lap_joint_example, "Corner Lap Joint")),
    ]
...
def create_all_joint_examples(use_round_timbers=False) -> Union[Frame, List]:
    """
    ...
    frames = []
    pattern_index = 0
    for metadata, pattern_lambda in book.patterns:
        if "plain_joints" not in metadata.pattern_group_names:
            continue
        center = create_v3(Rational(pattern_index * 2), Rational(0), Rational(0))
        frame = pattern_lambda(center, use_round_timbers=use_round_timbers)
        if not isinstance(frame, Frame):
            raise TypeError(f"Expected Frame for plain_joints pattern '{metadata.pattern_name}'")
        frames.append(frame)
        pattern_index += 1
    ...
    accessories = []
    for frame in frames:
        cut_timbers.extend(frame.cut_timbers)
        if frame.accessories:
            accessories.extend(frame.accessories)

    return Frame(cut_timbers=cut_timbers, accessories=accessories, name="plain_joints")
