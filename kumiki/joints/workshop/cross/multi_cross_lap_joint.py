"""
Kumiki - Multi cross lap joint construction function
"""
...
from .plain_cross_lap_joint import cut_plain_cross_lap_joint
...
def cut_multi_cross_lap_joint_on_plane_aligned_timbers(
    timbers: List[TimberLike],
    starting_face_on_first_timber: TimberFace,
    cut_distance_ratios: List[Numeric] = [],
) -> Joint:
    """
