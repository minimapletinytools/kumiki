...
def cut_practice_board_in_dado_joint_on_plane_aligned_timbers(
    boards: PanelBoardArrangement,
    dado_timbers: ExtendedTimberArrangement,
    dado_depth: Numeric = scalar(0),
):
...
def cut_practice_sliding_dovetail_joint_on_orthogonal_boards(
    ...
    dovetail_length: Optional[Numeric] = None,
    shorten_dovetail_by: Numeric = scalar(0),
    extend_front_dovetail_housing_by: Union[None, Numeric] = scalar(0),
    ...
    s_butt_front = s_coord(front_face_plane.point)
